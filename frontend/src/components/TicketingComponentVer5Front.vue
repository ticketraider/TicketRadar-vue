...
const fetchBookedTicket = async () => {
  ...
  try {
    const response = await axios.get(`http://43.200.140.164:8080/tickets/ticket-list/${eventId}`, {
...
const submitTicketReservation = async () => {
  ...
  try {
    await axios.post(`https://43.200.140.164:80/tickets/create`, reservationDetails
        ,
        {
          headers: {
