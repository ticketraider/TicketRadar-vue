...
const fetchBookedTicket = async () => {
  ...
  try {
    const response = await axios.get(`https://www.ticketradar.net/tickets/ticket-list/${eventId}`, {
...
const submitTicketReservation = async () => {
  ...
  try {
    await axios.post(`https://www.ticketradar.net/tickets/create`, reservationDetails
        ,
        {
          headers: {
